...
% Zmena pracovného adresáru na adresár so zdrojovým kódom programu GrafLab
cd graflab-master/src/

% Výpočet a zobrazenie zemskej topografie do rôznych stupňov "nmax"
for nmax = [30, 90, 360];

    GrafLab('OK', 1.0, 1.0, 0, nmax, [0 0 0 0 0],  '../data/input/DTM2006.mat', ...
            1, 0, -90.0, 0.25, 90, 0.0 ,0.25, 360.0, 0.0, [], [], [], [], ...
...
% Prechod do pôvodného pracovného adresáru
cd ../../
