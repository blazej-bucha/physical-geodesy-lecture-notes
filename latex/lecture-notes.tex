...
v(t_0)$ sa tak planéta sa dostane do bodu $P(t_1)$.  V čase $t_1$ sa opísaná 
...
fyzikálnu geodéziu majú teda ekvipotenciálne plochy veľký význam.  Zamerajme sa 
preto na niektoré ich vlastnosti.
...
rýchlosti rotácie telesa $\omega$ a zmenou polohy bodu voči osi rotácie.  Zmeny 
týchto parametrov majú v prípade Zeme výrazne menší vplyv na tvar 
ekvipotenciálnych plôch ako tvar a hustota Zeme, preto ich pre túto chvíľu 
zanedbajme.}  Na regionálnej úrovni je nepravidelný tvar ekvipotenciálnych 
plôch spôsobený do veľkej miery lokálnymi hmotami, napríklad pohoriami.  
Z globálneho pohľadu je tvar ekvipotenciálnych plôch daný skôr celkovou 
geometriou telesa ako takého (napríklad sploštenie Zeme), či rozsiahlymi 
hustotnými kontrastami.  Práve tieto skutočnosti výrazne komplikujú presný 
výpočet geoidu, jednej ekvipotenciálnej plochy z nekonečného množstva 
...
Z dôvodu zvlnenia ekvipotenciálnych plôch však nemožno vo všeobecnosti 
predpokladať rovnobežnosť horizontálnych rovín na dvoch rôznych stanoviskách.  
V prípade teodolitu sú v tejto rovine merané vodorovné smery.  Preto ak je 
vyžadovaná presnosť vysoká alebo záujmová lokalita je rozsiahla a má zložitú 
topografiu, potrebné je korigovať merania o vplyv tiažového poľa.
...
teda smer vektora tiažového zrýchlenia predstavuje dotyčnicu k tiažnici.
...
horizontovaní prístroja za predpokladu, že horizontálna os prístroja je kolmá 
na jeho vertikálnu os.  K lokálnej zvislici sa vzťahujú merané vertikálne 
smery.  Zvlnenie ekvipotenciálnych plôch spôsobuje, že vertikálne osi 
zhorizontovaných prístrojov nie sú medzi dvoma stanoviskami vo všeobecnosti 
rovnobežné.  Podobne ako pri vodorovných smeroch, presné merania si môžu 
vyžadovať zavedenie korekcii z tiažového poľa.
