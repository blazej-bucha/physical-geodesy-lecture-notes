...
otázku, prečo majú veľmi hmotné objekty, napríklad planéty, či Slnko, približne 
sférický tvar.  Je pozoruhodné, že hoci Newtonov gravitačný zákon bol 
odpozorovaný z pohybu nebeských telies, zhoduje sa i s experimentmi, ktoré boli 
vykonané na vzdialenosť niekoľkých desiatok mikrometrov \citep{Lee2020}.
...
Z predchádzajúcej kapitoly vyplýva, že v sústave $N$ hmotných bodov je pre 
získanie celkového gravitačného zrýchlenia potrebné započítať všetky čiastkové 
zrýchlenia udeľované jednotlivými hmotnými bodmi.  Gravitačné zrýchlenie je 
v takom prípade dané vektorovým súčtom,
%
\begin{equation}
...
Zaveďme pojem \emph{všeobecné teleso}, ktoré má konečný objem $\tau$ 
a ohraničenú hustotu $\rho$.  Rozdeľme toto teleso na nekonečne veľa 
...
akokoľvek sú malé, nikdy nie sú totožné s hmotnými bodmi; navyše, hmota týchto 
elementov je koncentrovaná do jedného bodu \citep{Kellogg1967}.
...
je mladší ako Newtonov gravitačný zákon \citep{Jekeli2015} a chápe fenomén 
gravitácie ako \emph{pole}, ktorého vlastnosti môžu byť popísané rôznymi 
veličinami, pričom však ide stále o to isté pole.  Ak by sme teda našli 
...
nazýva \emph{gravitačný potenciál} a označuje sa symbolom $V$.
...
rýchlosti jej zmeny v smere jednotlivých súradnicových osí.  Vhodnou aplikáciou 
rotačných matíc je možné následne získať informáciu o rýchlosti zmeny funkcie 
v ľubovoľnom smere, čo je v mnohých situáciach veľmi nápomocné.  Rýchlosť zmeny 
funkcie je tu myslená v priestorovom, nie časovom zmysle.  Ak si predstavíme 
povrch Zeme ako dvojrozmernú funkciu zemepisnej šírky a dĺžky, potom aplikáciou 
operátora gradient na túto funkciu získame (nielen) v kopcovitom teréne 
informáciu o smere, ktorým sa z tohto bodu zrejme nechceme vydať na bicykli.  
Stačí však dať pred túto vektorovú funkciu znamienko mínus a zvyšok práce 
nechať na gravitáciu.  Numerická ukážka aplikácie operátora gradient je spolu 
so zdrojovým kódom uvedená 
