...
(Kapitola~\ref{sec:spheroidal_harmonic_functions}) a~rozvoj gravitačné 
potenciálu do sféroidického harmonického radu 
...
\label{sec:spheroidal_harmonic_functions}
...
presnosťou v~porovnaní s~výpočtom nekonečného radu obmedzeného na vhodne 
zvolený konečný počet členov.  V~tejto kapitole sa preto budeme snažiť nájsť 
uzavretý vzťah na výpočet normálneho tiažového potenciálu v~bodoch na povrchu 
ekvipotenciálneho elipsoidu a~nad ním.  Táto kapitola je spracovaná 
...
potenciál na elipsoide má dve symetrie, jednu voči rovine rovníka a druhú voči 
osi rotácie.  Prvá symetria spôsobuje, že nenulové môžu byť iba párne zonálne 
sféroidické harmonické koeficienty (pozri vlastnosti sférických harmonických 
funkcií Kapitolu~\ref{sec:spherical_harmonics}), druhá spôsobuje, že všetky 
nezonálne koeficienty musia byť nulové, pretože závisia od dĺžky~$\lambda$ 
(pozri rovnicu~\ref{eq:vg_spheroidalh_no_norm}).  Normálny tiažový potenciál 
môžeme teda zapísať v~tvare
%
\begin{equation}
\label{eq:u_sph}
\begin{split}
...
odstredivý potenciál.  Pre jednoduchosť sme do vzťahu zahrnuli aj nepárne 
zonálne koeficienty~$C^{\mathrm{r}}_n$ hoci vieme, že sú nulové.
...
koeficienty normálneho poľa $C_n^\mathrm{r}$ je možné vypočítať zo štyroch 
základných parametrov ekvipotenciálneho elipsoidu (pozri 
Kapitolu~\ref{sec:equipotential_ellipsoid}).  Skúsme preto zistiť, čomu sú 
rovné koeficienty $C_n^\mathrm{r}$.

Nech sa výpočtový bod nachádza na povrchu ekvipotenciálneho elipsoidu, teda $u 
= b$.  Potom
%
\begin{equation}
\frac{Q_n\left( i \dfrac{b}{E} \right)}{Q_n\left( i \dfrac{b}{E} \right)} 
= 1{,}
\end{equation}
%
