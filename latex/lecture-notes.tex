...
napríklad náhle ostré zmeny.  Hoci sú takéto oblasti krásne na pohľad, 
...
súradniciach \parencite[pozri napríklad][]{MoritzPhysicalGeodesy}.
...
(pozri napríklad \cite{Torge1989,Rozimant1994} či \cite{Janak2010}).  
...
\ \mathrm{m}$ na vzdialenosť jedného kilometra 
...
napríklad v~prácach \textcite{Janak2006} a~\textcite{MoritzPhysicalGeodesy}.
...
\parencite[napríklad][]{MoritzPhysicalGeodesy,Janak2006}.
...
rekurentných vzťahov (pozri napríklad \cite{Holmes2002a} či
\cite{Fukushima2012a}).
...
nadobúda až približne od stupňa $10{,}800$ \parencite{Hirt2016,Rexer2017}.
...
a získaná dodatočná presnosť zväčša nie je významná \parencite{Moritz1967}.
...
\parencite{MoritzPhysicalGeodesy}.  Z fyzikálneho hľadiska je už medzi 
elipsoidmi rozdiel väčší.  Uhlová rýchlosť rotácie oboch elipsoidov je síce 
rovnaká, no odlišné hodnoty geocentrických gravitačných konštánt spôsobujú 
rozdiel v~normálnom tiažovom potenciáli na elipsoide, $U_{0}^{\mathrm{GRS80}} 
= 62\, 636\, 860.850\ \mathrm{m}^2 \, \mathrm{s}^{-2}$ 
a $U_{0}^{\mathrm{WGS84}} = 62\, 636\, 851.715\ \mathrm{m}^2 \, 
