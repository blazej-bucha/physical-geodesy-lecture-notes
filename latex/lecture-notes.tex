...
Ďalšou možnosťou definície ekvipotenciálneho elipsoidu je použiť namiesto 
koeficientu~$J_{2,0}$ sploštenie~$f$,
%
\begin{equation}
f = \frac{a - b}{b}{.}
\end{equation}
...
\end{equation}
%
Normálny tiažový potenciál z~rovnice~(\ref{eq:u_sph}) je teda daný vzťahom
%
\begin{equation}
\label{eq:ug_spheroidal}
\begin{split}
U(u, \beta) &= \left( U_0 - \frac{1}{3} \, \omega^2 \, a^2 \right) \, 
...
%
&\phantom{={}}+\frac{1}{2} \, \omega^2 \, (u^2 + E^2) \, \cos^2\beta{.}
\end{split}
\end{equation}
%
...
Rovnicu~(\ref{eq:ug_spheroidal}) možno ďalej upraviť tak, aby v~nej jedinými 
konštantami boli základné parametre ekvipotenciálneho elipsoidu $a$, $E$ 
(alebo~$b$), $G\, M$ a $\omega$.  Toto odvodenie vynecháme a uvedieme iba 
výsledný vzťah \parencite{MoritzTheFigureOfTheEarth},
%
\begin{equation}
...
%
\begin{equation}
q = \frac{1}{2} \left[ \left( 1 + 3 \, \frac{b^2}{E^2}\right) \, 
...
harmonických funkcií s~rôznymi váhami (súradnicami) $C_n^\mathrm{r}$, je 
taktiež harmonická funkcia, keďže Laplaceov operátor je lineárny (pozri 
