...
sa nazýva \emph{Coriolisova sila}.  Azda väčšina meracích geodetických 
...
vzájomným silovým pôsobením medzi objektmi ako je tomu napríklad v prípade 
gravitačnej sily.
...
vektorovým súčtom (Obrázok~\ref{fig:gravity_vector}),
%
\begin{equation}
\label{eq:g}
...
a (\ref{eq:ynk_times_ynk}) ponecháme na čitateľa.\footnote{Poznámka: Je 
