...
potenciálu môže byť určený nepriamo.  Pred vysvetlením metódy určovania 
rozdielu tiažového potenciálu sa však pristavme pri pojme totálny diferenciál.
...
bode $\vec x$ a zadanom smere~$\Delta \vec x$.  Skrátením vzdialenosti~$\Delta 
\vec x$ na~$\diff \vec x$ je možné zmenšiť aproximačnú chybu na ľubovoľne malú 
hodnotu.
