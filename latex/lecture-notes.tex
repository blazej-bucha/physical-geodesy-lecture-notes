...
planéty a Slnka.  Pôsobením tejto sily sa však planéta nezačne pohybovať 
v smere sily, pretože okamžitý vektor rýchlosti $\vec v(t_0)$ má iný smer ako 
sila $\vec F_\gidx(t_0)$.  Stane sa to, že gravitačná sila zmení hypotetickú 
trajektóriu, ktorou by sa planéta pohybovala bez jej pôsobenia, a planéta sa 
tak dostane nie do bodu $P'(t_1)$, ale do bodu $P(t_1)$.  V čase $t_1$ sa 
opísaná situácia opakuje, pričom vektory rýchlosti a sily už majú iný smer 
a s vysokou pravdepodobnosťou aj inú veľkosť.  Takýmto spôsobom gravitačná sila 
Slnka určuje v každom okamihu obežnú dráhu planéty.
%
\begin{figure}
\centering
...
Spomeňme si na úvodnú kapitolu, v ktorej jeden z prístupov definuje tvar Zeme 
ako geoid, teda tú ekvipotenciálnu plochu, ktorá koinciduje s hladinou morí 
a oceánov.  Pre fyzikálnu geodéziu majú teda ekvipotenciálne plochy veľký 
význam.  Zamerajme sa preto na niektoré ich vlastnosti.

\begin{figure}
\centering
\input{./fig-equipotential-surfaces.pdf_tex}
\caption{Ekvipotenciálne plochy}
...
pretínajú nie sú analytické, pretože ich krivosť sa môže nespojito meniť 
v závislosti od hustoty.  Všetky ekvipotenciálne plochy sú hladké a neobsahujú 
hrany \citep{MoritzPhysicalGeodesy}.

\item Ekvipotenciálne plochy sa nikde nepretínajú.  Tiažový potenciál $W$ má 
v každom bode definované práve jedno číslo (skalárna veličina), preto sa 
ekvipotenciálne plochy nemôžu pretnúť \citep{MacMillan1930}.
...
Spojitosť s meraním, libela, atď
