...
\ref{sec:spherical_harmonics_applications} 
a \ref{sec:physical_meaning_of_spherical_harmonic_coefficients} následne 
popíšeme normovanie sférických harmonických funkcií, ich praktické aplikácie 
a fyzikálny význam niektorých sférických harmonických koeficientov.
...
podobné tým nenormovaným~(\ref{eq:pnm_recurrence}) (pozri napríklad 
...
Ak používame sférické harmonické funkcie normované členom $N_{n|k|}$, potom 
sférické harmonické koeficienty musia byť normou $N_{n|k|}$ vydelené, aby sa 
zachovala rovnosť vo vzťahoch~(\ref{eq:vg_sh_no_norm}) 
...
$\bar{Y}_{nk}(\varphi, \lambda)$ a napríklad vzťahom~(\ref{eq:f_sha}) sa 
získajú priamo úplne normované sférické harmonické koeficienty.
