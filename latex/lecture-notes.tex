...
funkcií~(\ref{eq:vg_sh_no_norm}), potom oblasť blízko telesa, kde rad nemusí 
konvergovať môže byť pomerne rozsiahla (porovnaj 
...
\emph{elipsoidické redukované súradnice}, ktoré vedú ku \emph{sféroidickému 
harmonickému rozvoju} gravitačného potenciálu.  Výhodou sféroidického 
harmonického rozvoja je skutočnosť, že oblasť, v~ktorej je príslušný harmonický 
rad konvergentný môže byť väčšia v~porovnaní so sférickým rozvojom (pozri 
Obrázok~\ref{fig:spheroidal_harmonics_convergence}).

V~tejto kapitole stručne popíšeme elipsoidické redukované súradnice 
(Kapitola~\ref{sec:ellipsoidal_reduced_coordinates}) a~sféroidický harmonický 
rozvoj (Kapitola~\ref{sec:spheroidal_harmonic_expansion}).
...
\label{sec:ellipsoidal_reduced_coordinates}
...
nad ním, možno vyjadriť pomocou elipsoidických redukovaných súradníc $u$, 
$\beta$ a $\lambda$ (Obrázok~\ref{fig:ell_reduced_coords}).  Symbol $u$ 
...
\begin{figure}
\centering
\input{./fig-ell-reduced-coords.pdf_tex}
\caption{Elipsoidické redukované súradnice $u$ a $\beta$ bodu $P$}
\label{fig:ell_reduced_coords}
\end{figure}

Jednoduchým spôsobom možno overiť, že medzi elipsoidickými redukovanými 
